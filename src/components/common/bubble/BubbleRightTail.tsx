...
export default function BubbleRightTail({
  text,
  top,
  left,
  bg = 'white',
  ...
  return (
    <div>
      <div className="absolute" style={{ top: `${top}px`, left: `${left}px` }}>
        <div
          className={`bubbleRightTail shadow-shadow1 h-fit text-nowrap rounded-lg border px-4.5 py-2 after:absolute after:border`}
          style={
            {
              background: bg,
              '--after-bg': bg,
