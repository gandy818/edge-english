      ...
      <div className="flex flex-col border-b border-t">
        {prevEvent && (
          <Link
            ...
            className="flex cursor-pointer gap-10 px-2 py-6"
          >
            ...
            <p className="truncate text-edge-gray max-md:max-w-56">{prevEvent?.title}</p>
          </Link>
        )}

        {nextEvent && (
          <Link
            href={`/events/${nextEvent.index}`}
            className={`flex gap-10 px-2 py-6 ${prevEvent ? 'border-t' : ''}`}
          >
            <div className="flex gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="truncate text-edge-gray max-md:max-w-56">{nextEvent?.title}</p>
          </Link>
        )}
      </div>
