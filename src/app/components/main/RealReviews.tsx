...
export default function RealReviews() {
  ...
  return (
    ...
    //   {/* 키드1 */}
    //   <div className="card card-lg w-[33.75rem] rounded-3xl bg-base-100 shadow-sm">
    //     <div className="card-body gap-4 rounded-3xl border text-center">
    //       <p className="content-center">
    //         엣지영어 진짜 최고! 다른 플랫폼은 필리핀 선생님들이 많아서 발음이 조금
    //         아쉬웠는데, 여긴 미국, 영국, 호주 같은 영어 주 사용 국가 선생님들만 있어서
    //         본토 발음을 배울 수 있어서 너무 좋았어요! 수업 들을 때마다
    //         <span className="bg-[#FFD4014D] font-semibold">
    //           영어에 더 자신감 생기는 느낌이에요!
    //         </span>
    //       </p>
    //       <div className="card-actions justify-center">
    //         <button className="btn rounded-full border-none bg-[#FFEB00]">
    //           직장인 강OO 님
    //         </button>
    //       </div>
    //     </div>
    ...
    //         엣지영어에서 제일 맘에 드는 건 수업 시작할 때마다 복습을 꼭 한다는 거예요!
    //         <span className="bg-[#FFD4014D] font-semibold">
    //           그날 배운 내용을 다시 점검해 주니까 머릿속에 확실히 남아요. 덕분에 영어
    //           실력이 더 빨리 느는 것 같아요!
    //         </span>
    //       </p>
    //       <div className="card-actions justify-center">
    ...
    //   <div className="card card-lg w-[33.75rem] rounded-3xl bg-base-100 shadow-sm">
    //     <div className="card-body gap-4 rounded-3xl border text-center">
    //       <p className="content-center">다른 영어 플랫폼은 약간 기계적인 느낌</p>
    //       <div className="card-actions justify-center">
    //         <button className="btn rounded-full border-none bg-[#FFEB00]">
    //           대학생 김OO 님
    //         </button>
    ...
    //     <div className="card-body gap-4 rounded-3xl border text-center">
    //       <p className="content-center">
    //         강사님께서 제가 서투르게 말한 문장을 하나하나 워드에 적어 주시고, 같이 보면서
    //         바로 고쳐 주셨어요. 매 수업마다
    //         <span className="bg-[#FFD4014D] font-semibold">
    //           제 문장을 함께 수정하고 따라 읽는 과정을 반복하다 보니, 어느새 자연스럽게
    //           영어 문장을 말하고 있는 제 모습을 발견했답니다.
    //         </span>
    //         평생 콤플렉스였던 영어를 이렇게 재미있게 배울 수 있었다니, 정말 신기하고
    //         감사할 따름입니다!
    //       </p>
    //       <div className="card-actions justify-center">
    //         <button className="btn rounded-full border-none bg-[#FFEB00]">유OO 님</button>
    //       </div>
    //     </div>
    //   </div>
    // </div>
